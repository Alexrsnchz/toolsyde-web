...
import { DownloadIcon, LinkIcon, QrCodeIcon, SpinnerIcon } from '@icons/Icons'
...
export default function QrCodeGenerator() {
  ...
  const { qrBlobUrl, isLoading, onSubmit, onDownloadQr } = useQr()
        ...
        <section className="flex flex-col gap-4 border border-gray-200 rounded-md p-6 h-full">
          ...
          >
            ...
            <div className="flex gap-2 mt-4">
              <button
                className="py-2 bg-black text-white font-medium text-sm rounded-md w-full hover:cursor-pointer disabled:opacity-50"
                disabled={isLoading}
              >
