...
export default function QrCodeGenerator() {
  ...
  return (
    <>
      <header className="py-6.5 px-5 border-b-2 border-gray-300">
      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-77.6px)] px-4">
        <article className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full items-center">
          ...
          <section className="flex flex-col gap-4 border border-gray-200 rounded-md p-6 h-full">
            ...
            <div className="bg-gray-200 w-full h-72 rounded-md flex items-center justify-center">
              {isLoading ? (
                <SpinnerIcon className="animate-spin text-gray-500 size-6 inline fill-purple-800" />
              ) : qrBlobUrl ? (
