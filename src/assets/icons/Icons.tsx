...
export function ContractedPanelIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function SpinnerIcon({ className }: IconProps) {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className={`${className} animate-spin text-gray-500 size-6 inline fill-purple-800`}
        viewBox="0 0 100 101"
        fill="currentColor"
        xmlns="http://www.w3.org/2000/svg"
      >
...
export function CircleQuestionMarkIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function FileSlidersIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
